...
final class DoseLog {
    ...
    static func csvHeader() -> String {
        "night_date,bedtime,dose1_time,dose1_g,dose2_time,dose2_g,bathroom_wakes,final_wake,morning_alertness,notes"
    }
    ...
    func csvRow() -> String {
        ...
        let n = notes ?? ""
        return [nightDate, bt, d1t, d1g, d2t, d2g, wakes, fwt, ma, n].joined(separator: ",")
    }
}
