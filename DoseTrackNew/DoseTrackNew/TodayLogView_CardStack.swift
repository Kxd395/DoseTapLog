    ...
    var body: some View {
        NavigationStack {
            ...
            .sheet(isPresented: $vm.showEarlyDoseSheet) {
                EarlyDoseSheet(
                    minutes: .constant(5),
                    reason: .constant(.couldNotSleep),
                    allowed: 1...15,
                    quickChoices: AppPreferences.shared.earlyTimePriorDefaults.split(separator: ",").compactMap { Int($0) },
                    requireReason: AppPreferences.shared.requireEarlyReason,
    ...
    private var statusCard: some View {
        GroupBox {
            VStack(alignment: .leading, spacing: 8) {
                ...
                if AppPreferences.shared.liveActivityEnabled {
...
private struct EventRow: View {
    ...
    private var eventColor: Color {
        ...
        case .alarmWake, .finalWake: return .green
    ...
    private var eventDetail: String? {
        guard !event.detail.isEmpty else { return nil }
        return event.detail
    }
